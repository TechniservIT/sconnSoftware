...
namespace sconnMobileForms.View.AlarmSystem
{
    ...
    public partial class AlarmOutputsListView : ContentPage
    {
        ...
        public AlarmOutputsListView()
        {
            ...
            for (int i = 0; i < Configs.Count; i++)
            {
                ...
                AlarmIoEntityGrid devGrid = new AlarmIoEntityGrid(Configs[i],AlarmSystemIoType.Output);

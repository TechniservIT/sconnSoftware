...
{
    public class AlarmSystemOutputConfigurationController : AlarmSystemControllerBase, IAlarmSystemController, IAlarmSystemConfigurationController
    {
        private GsmConfigurationService _provider;

        public AlarmSystemOutputConfigurationController()
        {
                
        }

        public AlarmSystemOutputConfigurationController(HttpContextBase contBase) : base(contBase)
        { }

...
namespace sconnConnector
{
	...
	public class ipcDataType
	{
		...
		public class ipcDeviceConfig
		{
			...
			private void LoadInputsFromConfig()
			{
				...
				{
					sconnInput input = new sconnInput(_memCFG, i);
					Inputs.Add(input);
				}
			}
			...
			private void LoadOutputsFromConfig()
			{
				...
				{
					sconnOutput output = new sconnOutput(_memCFG, i);
					Outputs.Add(output);
				}
			}
			...
			private void LoadRelayFromConfig()
			{
				...
				{
					sconnRelay relay = new sconnRelay(_memCFG, i);
					Relays.Add(relay);
				}
			}
	...
	public struct ipcDefines
	{
		...
		public static byte mAdrInputMemSize = 0x06;
		...
		public static byte DeviceMaxInputs = 16;

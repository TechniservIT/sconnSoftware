...
namespace sconnConnector.Config.Manager
{
    ...
    *
    *AlarmGenericNamesConfigManager
    */

    //public class AlarmGenericNamesConfigManager<T> where T : new()
    //{
    //    protected IAlarmSystemNamedEntityConfig Entity;
    //    protected static Logger _logger = LogManager.GetCurrentClassLogger();
    //    protected SconnClient client;
    //    protected int EntityId;

    //    public AlarmGenericNamesConfigManager(IAlarmSystemNamedEntityConfig entity, Device device)
    //    {
    //        Entity = entity;
    //        client = new SconnClient(device.EndpInfo.Hostname, device.EndpInfo.Port, device.Credentials.Password, true);
    //    }

    //    public AlarmGenericNamesConfigManager(IAlarmSystemNamedEntityConfig entity, Device device, int EntityParam)
    //    {
    //        Entity = entity;
    ...
    //                Entity.DeserializeEntityNames(msgBody);
    //                client.Disconnect();
    //                return true;
    //            }

namespace iotDash.Migrations
{
    ...
    public partial class connector : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            CreateIndex("dbo.AspNetUsers", "Domain_DomainId");
            CreateIndex("dbo.AspNetUsers", "UserName", unique: true, name: "UserNameIndex");
            AddForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles", "Id", cascadeDelete: true);
            AddForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers", "Id", cascadeDelete: true);
            AddForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers", "Id", cascadeDelete: true);
            AddForeignKey("dbo.AspNetUsers", "Domain_DomainId", "dbo.iotDomains", "DomainId", cascadeDelete: true);
